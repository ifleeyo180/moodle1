...
/**
 * Strings for component 'bigbluebuttonbn', language 'zh_tw', version '3.11'.
 *
...
$string['bigbluebuttonbn:addinstance'] = '新增一個直播教室/活動';
$string['bigbluebuttonbn:join'] = '加入一個會議';
$string['bigbluebuttonbn:managerecordings'] = '管理錄影';
$string['bigbluebuttonbn:view'] = '檢視直播教室/活動';
$string['completionengagementemojis'] = '表情圖案';
...
$string['config_hideuserlist_default'] = '隱藏用戶清單的選擇預設啟用';
$string['config_hideuserlist_editable'] = '隱藏用戶清單的選擇可以修改';
$string['config_meetingevents_enabled'] = '登記直播活動';
$string['config_recordings_general'] = '顯示錄影的設定';
$string['config_recordings_imported_default'] = '預設啟用只顯示已匯入的連結';
$string['config_recordings_imported_editable'] = '只顯示已匯入的連結的功能可以修改';
...
$string['ends_at'] = '結束';
$string['event_activity_created'] = '已建立直播教學活動';
$string['event_activity_deleted'] = '已刪除直播教學活動';
$string['event_activity_updated'] = '已更新直播教學活動';
$string['event_activity_viewed'] = '檢視直播教學活動管理';
$string['event_live_session'] = '直播活動';
$string['event_meeting_created'] = '已建立直播教室';
$string['event_meeting_ended'] = '已強制結束直播教學';
$string['event_meeting_joined'] = '進入直播教室';
$string['event_meeting_left'] = '離開直播教室';
...
$string['index_confirm_end'] = '你希望結束直播課程嗎？';
$string['index_disabled'] = '已關閉';
$string['index_enabled'] = '已啟用';
$string['index_ending'] = '直播教室正要關閉...請等待';
...
$string['index_heading'] = '直播教室';
$string['index_heading_actions'] = '行動';
$string['index_heading_group'] = '群組';
$string['index_heading_moderator'] = '主持人';
$string['index_heading_name'] = '教室';
$string['index_heading_recording'] = '錄影紀錄';
$string['index_heading_users'] = '用戶';
$string['index_heading_viewer'] = '觀眾';
$string['instance_type_default'] = '教室/教學/錄影紀錄';
$string['instance_type_recording_only'] = '只顯示錄影紀錄';
$string['instance_type_room_only'] = '教室/教學';
$string['mod_form_block_general'] = '一般設定';
$string['mod_form_block_participants'] = '參與人員';
$string['mod_form_block_presentation'] = '簡報用檔案';
$string['mod_form_block_record'] = '錄製的設定';
$string['mod_form_block_recordings'] = '錄影紀錄的設定';
$string['mod_form_block_room'] = '教室與活動設定';
$string['mod_form_block_schedule'] = '直播時間安排';
$string['mod_form_field_closingtime'] = '關閉的時間';
$string['mod_form_field_conference_name'] = '會議名稱';
$string['mod_form_field_disablecam'] = '停用視訊鏡頭';
$string['mod_form_field_disablemic'] = '停用麥克風';
$string['mod_form_field_disablenote'] = '停用共享筆記';
$string['mod_form_field_disableprivatechat'] = '禁止私下聊天';
$string['mod_form_field_disablepublicchat'] = '禁止公開聊天';
$string['mod_form_field_duration'] = '長度';
$string['mod_form_field_duration_help'] = '設定會議時間的長度，可讓會議錄製檔結束之前，維持會議持續運作。';
$string['mod_form_field_hideuserlist'] = '隱藏用戶清單';
$string['mod_form_field_instanceprofiles'] = '使用型態';
$string['mod_form_field_intro'] = '說明';
$string['mod_form_field_intro_help'] = '直播教室或會議的簡短描述';
$string['mod_form_field_lockedlayout'] = '鎖定直播室的畫面編排';
$string['mod_form_field_lockonjoin'] = '忽略功能停用設定';
$string['mod_form_field_lockonjoinconfigurable'] = '允許忽略功能停用設定';
$string['mod_form_field_muteonstart'] = '開始時靜音';
$string['mod_form_field_name'] = '直播教室名稱';
$string['mod_form_field_nosettings'] = '不用修改設定值';
...
$string['mod_form_field_record'] = '直播時可以側錄留存';
$string['mod_form_field_recordhidebutton'] = '隱藏錄影按鈕';
$string['mod_form_field_recordings_imported'] = '只顯示已匯入的連結';
$string['mod_form_field_room_name'] = '直播教室名稱';
...
$string['mod_form_field_voicebridge_notunique_error'] = '不是獨一無二的數值。這數字已經被其他教室或會議所使用。';
$string['mod_form_field_wait'] = '等候主持人';
$string['mod_form_field_wait_help'] = '觀眾必須等待，直到一個主持人進入這視訊會議';
$string['mod_form_field_welcome'] = '歡迎訊息';
$string['mod_form_field_welcome_default'] = '<br>歡迎來到<b>%%CONFNAME%%</b>!<br><br>要了解此視訊會議系統如何運作，請看我們的 <a href="event:http://www.bigbluebutton.org/content/videos"><u>教學影片</u></a>。<br><br>若您想要加入聲音對話，請點選(下方)藍色耳機圖示。 <b>請您戴上耳機以免干擾到別人。</b>';
...
$string['mod_form_locksettings'] = '功能停用設定';
$string['modulename'] = '直播教學';
$string['modulename_help'] = 'BigBlueButton 是用於遠距教育的一種開放源碼的網路會議系統。而
BigBlueButton 可讓你經由 Moodle 的連結建立一個即時、線上的直播教室(或稱虛擬教室)。

使用BigBlueButton 您可以指定標題、說明、行事曆項目 (設定可加入會議的起迄時間)、群組，和有關此線上會議錄影的細節。';
$string['modulenameplural'] = '直播教學';
$string['pluginadministration'] = '直播教學管理';
$string['pluginname'] = '直播教學';
$string['started_at'] = '已經開始';
$string['starts_at'] = '開始';
$string['view_conference_action_end'] = '結束直播';
$string['view_conference_action_join'] = '參加直播';
...
$string['view_groups_nogroups_warning'] = '直播教室已設定為群組使用，但是這個課程並未訂定群組。';
$string['view_groups_selection'] = '選擇你要加入的群組，並加以確認';
$string['view_groups_selection_join'] = '參加';
$string['view_groups_selection_warning'] = '這是一個為各群組開設的直播教室，如果您有參加多個群組，請先確認您選擇了正確的群組，才不會跑錯教室。';
...
$string['view_message_conference_room_ready'] = '直播教室已經準備好，您現在可以立刻參加。';
...
$string['view_message_room_closed'] = '教室關閉了。';
$string['view_message_room_open'] = '教室開放了。';
$string['view_message_room_ready'] = '教室已經準備好了。';
...
$string['view_mobile_message_reload_page_creation_time_meeting'] = '您離開了這頁面超過45秒，請重新載入頁面才能正確地參加會議。';
$string['view_noguests'] = '直播教室未開放給訪客參加';
...
$string['view_recording_button_return'] = '返回';
...
$string['view_recording_format_presentation'] = '播放';
$string['view_recording_format_screenshare'] = '螢幕分享';
...
$string['view_recording_list_action_delete'] = '刪除中';
$string['view_recording_list_action_edit'] = '更新中';
$string['view_recording_list_action_play'] = '撥放';
$string['view_recording_list_actionbar'] = '工具列';
$string['view_recording_list_actionbar_delete'] = '刪除';
$string['view_recording_list_actionbar_edit'] = '編輯';
$string['view_recording_list_actionbar_hide'] = '隱藏';
$string['view_recording_list_actionbar_import'] = '匯入';
$string['view_recording_list_actionbar_protect'] = '標記為隱藏';
$string['view_recording_list_actionbar_publish'] = '公布';
$string['view_recording_list_actionbar_show'] = '顯示';
$string['view_recording_list_actionbar_unprotect'] = '標記為公開';
...
$string['view_recording_meeting'] = '教室';
$string['view_recording_modal_button'] = '套用';
$string['view_recording_modal_title'] = '設定錄影的參數';
$string['view_recording_name'] = '名稱';
$string['view_recording_playback'] = '播放';
$string['view_recording_preview'] = '預覽';
$string['view_recording_preview_help'] = '滑鼠移到圖片上方可以檢視完整大小';
...
$string['view_recording_yui_first'] = '前';
$string['view_recording_yui_go'] = '前往';
$string['view_recording_yui_last'] = '後';
$string['view_recording_yui_next'] = '往後';
$string['view_recording_yui_page'] = '頁';
$string['view_recording_yui_prev'] = '向前';
$string['view_recording_yui_rows'] = '筆數';
$string['view_recording_yui_show_all'] = '顯示全部';
$string['view_room'] = '看教室';
