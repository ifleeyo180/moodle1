...
/**
 * Strings for component 'journal', language 'zh_tw', version '3.11'.
 *
 * @package     journal
 * @category    string
...
$string['journalmail'] = '{$a->teacher} 已經在“ {$a->journal} ”中為您寫了回饋意見。 您可以在這裏看到回饋的內容： {$a->url}';
$string['journalmailhtml'] = '{$a->teacher} 已經在<i>“ {$a->journal} ”</i>中為您寫了回饋意見。<br/><br/> 您可以在<a href="{$a->url}">這裏</a>看到回饋的內容：';
$string['journalname'] = '心得報告名稱';
$string['journalquestion'] = '歷程紀錄問題';
$string['mailsubject'] = '心得報告回饋';
