...
/**
 * Strings for component 'quiz', language 'zh_tw', version '3.11'.
 *
 * @package     quiz
 * @category    string
...
$string['completionattemptsexhausteddesc'] = '如果可用的作答次都已用完，即算完成這一活動';
$string['completiondetail:passgrade'] = '獲得及格分數';
...
$string['completionpassdesc'] = '學生必須達到一個及格分數，才算完成這一活動';
...
$string['markall'] = '提交頁';
$string['marks'] = '得分';
$string['marks_help'] = '指每一個試題的得分和整個作答的分數。';
$string['match'] = '配合題';
...
$string['summaryofattempts'] = '您先前的作答記錄摘要';
