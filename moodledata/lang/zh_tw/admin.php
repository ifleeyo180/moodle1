...
/**
 * Strings for component 'admin', language 'zh_tw', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['configallowblockstodock'] = '如果啟用，且選用的佈景有支援，那麼用戶可以將區塊移動到一個特別的靠泊區中';
...
$string['configenableactivitychooser'] = '這活動選擇器是一個對話方塊，裡面有每一個活動和資源的簡短描述。如果被關閉，將改以個別的資源和活動的下拉選單來代替。';
...
$string['enableactivitychooser'] = '啟用活動挑選器';
...
$string['linkcoursesections'] = '永遠連結課程單元';
$string['linkcoursesections_help'] = '永遠嘗試為課程單元提供一個連結。如果課程的格式為每一頁顯示一個單元時，通常將課程單元顯示為連結。如果這一設定被啟用，會提供一個連結。';
$string['loading'] = '載入中';
...
$string['moodleapp'] = 'Moodle 應用程式';
$string['moodleservices'] = '服務';
...
$string['registermoodlenet'] = '<p>我們希望與您保持聯繫，並為您的Moodle網站提供重要的東西！</ p> <p>經由註冊：</ p> <ul>
<li>您將成為第一個收到重要通知，比如，安全警報和新的Moodle版本。</ li>
<li>您可以通過我們的免費<a href =“https://download.moodle.org/mobile /“>Moodle APP</a>從您的Moodle網站訪問並激活移動裝置推送通知。</ li>
<li>您正在為我們的<a href=\'https://moodle.net/stats/\'> Moodle統計數據</a>做出貢獻。這個全球社群幫助我們改進了Moodle和我們的社群網站。</ li>
<li>如果您願意，您的網站可以包含在<a href=\'https://moodle.net/sites/\'>您的國家已註冊的Moodle網站列表中</a>。</ li>
</ ul>';
$string['registermoodleorg'] = '當您註冊您的網站';
...
$string['taskdeletecachetext'] = '刪除舊的文字快取紀錄';
