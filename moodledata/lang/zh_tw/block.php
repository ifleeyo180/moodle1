...
/**
 * Strings for component 'block', language 'zh_tw', version '3.11'.
 *
 * @package     block
 * @category    string
...
$string['dockblock'] = '靠泊{$a}區塊';
$string['hideblock'] = '隱藏 {$a} 區塊';
$string['hidedockpanel'] = '隱藏靠泊面板';
...
$string['undockall'] = '卸下全部';
$string['undockblock'] = '把{$a}區塊移出泊靠區';
$string['undockitem'] = '卸下此項';
$string['visible'] = '可看見的';
$string['weight'] = '權重';
