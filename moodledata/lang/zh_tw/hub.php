...
/**
 * Strings for component 'hub', language 'zh_tw', version '3.11'.
 *
 * @package     hub
 * @category    string
...
$string['mobilenotificationsenabled'] = '已經啟用行動裝置通知({$a})';
$string['mobileservicesenabled'] = '已經啟用行動裝置通知({$a})';
...
$string['registeredactiveuserdevices'] = '活躍用戶註冊的行動裝置的數量({$a})';
$string['registeredcourses'] = '已註冊的課程';
$string['registeredsites'] = '已註冊的網站';
$string['registereduserdevices'] = '用戶註冊的行動裝置的數量({$a})';
$string['registersite'] = '在{$a}註冊';
$string['registerwithmoodleorg'] = '向 Moodle.org 註冊您的網站';
