...
/**
 * Strings for component 'lti', language 'zh_tw', version '3.11'.
 *
 * @package     lti
 * @category    string
...
$string['global_tool_types'] = '全站的預先配置的工具';
$string['grading'] = '分數路由';
...
$string['using_tool_configuration'] = '使用工具的配置：';
