...
/**
 * Strings for component 'hvp', language 'zh_tw', version '3.11'.
 *
 * @package     hvp
 * @category    string
...
$string['maxpostsizetoosmall'] = '您PHP設定的最大傳輸資料量太小. 使用您當前的設定, 您不能上傳大於{$a->%number} MB的文件.  試圖上傳H5P, 圖片和視頻時, 這將可能是一個問題. 請考慮增加到5MB以上';
$string['maxscore'] = '最高分';
$string['maxuploadsizetoosmall'] = '您PHP設定的最大傳輸資料量太小. 使用您當前的設置, 您不能上傳大於{$a->%number} MB的文件.  試圖上傳H5P, 圖片和視頻時, 這可能是一個問題. 請考慮增加到5MB以上';
