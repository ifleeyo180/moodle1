...
/**
 * Strings for component 'completion', language 'zh_tw', version '3.11'.
 *
 * @package     completion
 * @category    string
...
$string['bulkcompletiontracking'] = '進度追蹤';
...
$string['showcompletionconditions_help'] = '活動完成條件始終顯示在活動頁面上。 此設置確定活動完成條件是否也顯示在課程頁面上每個活動的下方。';
