...
/**
 * Strings for component 'grades', language 'zh_tw', version '3.11'.
 *
 * @package     grades
 * @category    string
...
$string['availableidnumbers'] = '可使用的學號';
$string['average'] = '平均';
...
$string['calculation_help'] = '成績計算方法是一個用來決定成績的公式。該公式應該以等號（=）開始，且可以使用常見的數學運算，比如max、min和sum。如果需要，你也可以包含其它評分項目，你只需在公式中輸入它們的學號，並用兩個方括號括起來。';
