...
/**
 * Strings for component 'moodle', language 'zh_tw', version '3.11'.
 *
 * @package     moodle
 * @category    string
...
$string['categorybulkaction'] = '對於被選出類別的批量操作';
...
$string['coursebulkaction'] = '對於被選出課程的批量操作';
...
$string['courseduration_desc'] = '這課程期限是用來計算這預設的課程結束日期。而課程結束日期只是用來做成績報告，在結束日期之後，用戶仍然可以進入這課程。';
...
$string['courses'] = '課程';
$string['coursesearch'] = '搜尋課程';
$string['coursesearch_help'] = '<p>您可以同時使用多關鍵字來搜尋。並以下列方法來改進您的搜尋</p>
<ul>
...
$string['coursevisibility'] = '課程可見度管制';
...
$string['defaulthomepageuser'] = '首頁';
$string['defaulthomepageuser_help'] = '您的首頁是導覽列中的第一個連結。';
$string['delete'] = '刪除';
...
$string['digitalminor_desc'] = '要在這網站上建立一個帳號，請你父母或監護人聯絡以下的人';
$string['directory'] = '目錄';
$string['disable'] = '取消';
...
$string['emaildisplay_help'] = '特權用戶（例如老師和管理員）將始終能夠看到您的電子郵件地址。';
$string['emaildisplaycourse'] = '只允許課程同學看到我的電子郵件信箱';
$string['emaildisplayno'] = '對特權用戶以外的人隱藏我的電子郵件信箱';
...
$string['hiddenoncoursepage'] = '可以使用，但沒有顯示在課程頁面上';
...
$string['hideoncoursepage'] = '啟動它但不要顯示在課程頁面';
...
$string['markedthistopic'] = '這一主題已被凸顯為當前主題';
$string['markthistopic'] = '將本主題凸顯為當前主題';
...
$string['maximumupload_help'] = '這個設定決定了可以上傳到這一課程的檔案最大容量，它不能夠比由網站管理員所做的全站設定值還要高。而課程中的每個活動模組也都包含有上傳檔案最大容量的設定，以進一步限制上傳檔案的大小。';
...
$string['newsitemsnumber_help'] = '這公告討論區是一種特殊討論區，它在課程中會自動建立，並卻設每位參與者都強制訂閱，而且只有被授權的用戶(預設為教師)可以在上面貼文。

此設定決定課程頁面上的最新公告區塊會出現幾則最新消息。如果設定為“0”，則最新公告區塊將不會顯示。';
$string['newuser'] = '新用戶';
...
$string['participantscount'] = '參與人數：{$a}';
...
$string['registrationno'] = '不，我不希望收到任何電子郵件。';
...
$string['showgrades_help'] = '許多活動都允許設定分數預設中，在課程中的所有分數都可以在成績頁中看到，在課程主頁中選單可找到。如果教師在課程中不想打分數，或只是不想讓學生看到成績，那他可以在課程設定頁中關閉成績簿的顯示。這樣做不會影響活動中使用或設定成績，它只是不讓學生看到而已。';
...
$string['sidepanel'] = '側板';
$string['signoutofotherservices'] = '任何地方都可登出';
$string['signoutofotherservices_help'] = '如果勾選，這帳號將會登出所有使用網頁服務的設備和系統，比如，行動裝置的應用程式。';
$string['since'] = '自從';
...
$string['userfilterplaceholder'] = '關鍵字搜尋或篩選';
