...
/**
 * Strings for component 'assign', language 'zh_tw', version '3.11'.
 *
 * @package     assign
 * @category    string
...
$string['attemptreopenmethod_help'] = '此設置決定學生作業能否有額外的嘗試。 對於每次繳交的作業，成績和回饋都會保存下來，並且可供老師和學生查看。 可用的選項有：

* 從不--- 學生不能再繳交作業。
* 手動的--- 須要由教師再允許學生交作業。
* 自動的，直到通過---- 學生可以一直重複繳交同一作業，直到分數超過在成績簿上設定的通過分數為止。';
...
$string['inactiveoverridehelp'] = '*學生沒有正確的群組或角色來做這個作業';
...
$string['recordid'] = '識別碼';
$string['removeallgroupoverrides'] = '刪除所有群組覆蓋';
$string['removealluseroverrides'] = '刪除所有用戶覆蓋';
$string['removesubmission'] = '刪除作業';
$string['removesubmissionconfirm'] = '您確定要刪除作業資料嗎？';
